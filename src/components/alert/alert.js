...
customElements.define('custom-alert',
  class CustomAlert extends HTMLElement {
    ...
    connectedCallback() {
      const alert = this.shadowRoot.querySelector('.alert-wrapper');
