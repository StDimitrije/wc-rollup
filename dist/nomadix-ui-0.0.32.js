  ...
  function libConfig(options) {
    if (options.loadEventListener) {
      ...
      if (document.querySelectorAll('sidenav-util-component')) {
        var _iterator = _createForOfIteratorHelper(document.querySelectorAll('sidenav-util-component')),
            _step;
      ...
      if (document.querySelectorAll('sidenav-ul-component')) {
        var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll('sidenav-ul-component')),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _item.setAttribute('event-changed', 'true');
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (document.querySelectorAll('submenu-ul-component')) {
        var _iterator3 = _createForOfIteratorHelper(document.querySelectorAll('submenu-ul-component')),
            _step3;
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _item2.setAttribute('event-changed', 'true');
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
